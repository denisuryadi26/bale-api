...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //permission for sholawat
        Permission::create(['name' => 'sholawats.index', 'guard_name' => 'api']);
        Permission::create(['name' => 'sholawats.create', 'guard_name' => 'api']);
        Permission::create(['name' => 'sholawats.edit', 'guard_name' => 'api']);
        Permission::create(['name' => 'sholawats.delete', 'guard_name' => 'api']);

        //permission for kerontang
        Permission::create(['name' => 'kerontangs.index', 'guard_name' => 'api']);
        Permission::create(['name' => 'kerontangs.create', 'guard_name' => 'api']);
        Permission::create(['name' => 'kerontangs.edit', 'guard_name' => 'api']);
        Permission::create(['name' => 'kerontangs.delete', 'guard_name' => 'api']);
